...
public class UserFacadeTest {
    ...
    public void setup() {
        ...
        user = new User("user", "STRONG_PASSWORD", roles);
    ...
    public void createUser_Success() throws DatabaseException, UserCreationException {
        ...
        // Act
        UserDTO actual = facade.createUser(user.getUserName(), "STRONG_PASSWORD");
    ...
    public void createUser_Failed_UserName_Already_In_Use() {
        assertThrows(UserCreationException.class, () -> {
            facade.createUser(user.getUserName(), "STRONG_PASSWORD");
        });
    }
